...
- [ ] **Theme Module:** Create `netmonitor/src/theme.rs` to define the theme structure and preset themes.
- [ ] **App State:** Update `netmonitor/src/app.rs` to include `current_theme`.
- [ ] **Keyboard Handling:** 
...
## 3. Verification
- [ ] **Functional Test:** Verify that changing the theme immediately updates all UI components (header, table, borders, alerts).
- [ ] **UI Test:** Ensure the theme selector dialog is intuitive and all themes are legible.
